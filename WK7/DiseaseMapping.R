...
setwd("/home/spr19/Desktop/PHC6194SPR2019/WK7")

#1. Smoothing

#load the data: sudden infant deaths in NC for 1974-1978 and 1979-1984
nc.sidsshp<-readOGR(dsn="/home/spr19/R/x86_64-pc-linux-gnu-library/3.5/spData/shapes/sids.shp",encoding="ESRI Shapefile")
...
#map
bubble(dat,"JAN",col=c("#00ff0088","#00ff0088"),main="January Temperature")
