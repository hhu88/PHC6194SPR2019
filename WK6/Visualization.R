...
setwd("/home/spr19/Desktop/PHC6194SPR2019/WK6")
...
map5<-map4+north(flbg_f,scale=0.2,symbol=3,location="topright")+scalebar(flbg_f,location="bottomleft",dd2km=T,dist=10,model="WGS84",st.dist = 0.05)
map5
