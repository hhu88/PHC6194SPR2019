...
#Q4. Create a connection to the "phc6194spr19db" database in postgresql, and export "dat" to the database as a table called "wk5.dat". DO NOT export row names. (4 pts)
