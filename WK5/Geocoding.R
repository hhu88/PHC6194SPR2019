...
setwd("/home/spr19/Desktop/PHC6194SPR2019/WK5/data")
...
#sudo -u postgres psql -c "SELECT set_geocode_setting('use_pagc_address_parser','true');" phc6194spr19db

#we can also switch back to the normalize_address
#sudo -u postgres psql -c "SELECT set_geocode_setting('use_pagc_address_parser','false');" phc6194spr19db
